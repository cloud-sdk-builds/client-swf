...
[`@aws-sdk/client-swf`](https://www.npmjs.com/package/@aws-sdk/client-swf/v/3.18.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-swf@3.18.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cyx5ksOMw6HveyuY6PyXUif24As8RJZAoShK+2oraN++79Xpd+SCUV167ZDdE3o9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-swf": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-swf@3.18.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-swf@3.18.0/index.min.mjs": "sha384-cyx5ksOMw6HveyuY6PyXUif24As8RJZAoShK+2oraN++79Xpd+SCUV167ZDdE3o9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-swf/blob/refs/tags/3.18.0/LICENSE
```
